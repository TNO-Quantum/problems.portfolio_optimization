...
ax.scatter(list(x2.values()), list(y2.values()), color="darkkhaki")
ax.scatter(list(x1.values()), list(y1.values()), color="mediumseagreen")
...
name = "figures/Port_Opt_Rabo_v6_points_" + str(datetime.datetime.now()) + ".png"
plt.savefig(name)
print(name)
# plt.show()
...
plt.grid()
# Name to save the figure under.
name = "figures/Port_Opt_Rabo_v6_front_" + str(datetime.datetime.now()) + ".png"
plt.savefig(name)
print(name)
# plt.show()
