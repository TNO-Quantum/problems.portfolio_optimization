...
fig, ax = plt.subplots()
ax.scatter(list(x3.values()), list(y3.values()), color="red")
ax.scatter(list(x2.values()), list(y2.values()), color="orange")
...
name = "figures/Port_Opt_Rabo_v3_points_" + str(datetime.datetime.now()) + ".png"
plt.savefig(name)
print(name)
# plt.show()
...
plt.grid()
# Name to save the figure under.
name = "figures/Port_Opt_Rabo_v3_front_" + str(datetime.datetime.now()) + ".png"
plt.savefig(name)
print(name)
# plt.show()
